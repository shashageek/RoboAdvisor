...
def validate_data(age, investment_amount, intent_request):
    ...
    """
    # Validate that the user is between zero and 65 years old.
    if age is not None:
        age = parse_int(
            age
        )
        if age < 0:
            return build_validation_result(
                False,
                "age",
                "Your age should be greater than zero, "
        ...
        if age > 65:
            return build_validation_result(
                False,
                "age",
                "Sorry I'm not able to provide you this service.",
            )
...
def recommend_portfolio(intent_request):
    ...
    # Get the investment recommendtion based on selected risk level
    if risk_level == "None":
        investment_strategy = "100% bonds (AGG), 0% equities (SPY)"
        
    elif risk_level == "Low":
        investment_strategy = "60% bonds (AGG), 40% equities (SPY)"
        
    elif risk_level == "Medium":
        investment_strategy = "40% bonds (AGG), 60% equities (SPY)"
        
    else:
        investment_strategy = "20% bonds (AGG), 80% equities (SPY)"
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            The {} investment strategy is recommended based your {} level of risk appetite.
            """.format(
                investment_strategy, risk_level
            ),
        },
    ) 
